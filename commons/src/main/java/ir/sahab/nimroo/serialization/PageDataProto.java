...
// source: commons/src/main/resources/pagedata.proto
...
public final class PageDataProto {
  ...
  public interface PageDataOrBuilder extends
    ...
    /**
     * <code>optional string h1 = 6;</code>
     */
    boolean hasH1();
    /**
     * <code>optional string h1 = 6;</code>
    ...
    /**
     * <code>repeated string h2 = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    private PageData() {
      ...
      h1_ = "";
      h2_ = com.github.os72.protobuf351.LazyStringArrayList.EMPTY;
    }
          ...
          switch (tag) {
            ...
            case 58: {
              ...
              if (!((mutable_bitField0_ & 0x00000040) == 0x00000040)) {
                h2_ = new com.github.os72.protobuf351.LazyStringArrayList();
    ...
    public static final int H1_FIELD_NUMBER = 6;
    ...
    public static final int H2_FIELD_NUMBER = 7;
    private com.github.os72.protobuf351.LazyStringList h2_;
    /**
     * <code>repeated string h2 = 7;</code>
     */
    ...
    public com.github.os72.protobuf351.ByteString
        getH2Bytes(int index) {
      return h2_.getByteString(index);
    }
    ...
    public void writeTo(com.github.os72.protobuf351.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        com.github.os72.protobuf351.GeneratedMessageV3.writeString(output, 6, h1_);
      }
      for (int i = 0; i < h2_.size(); i++) {
        com.github.os72.protobuf351.GeneratedMessageV3.writeString(output, 7, h2_.getRaw(i));
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000008) == 0x00000008)) {
        size += com.github.os72.protobuf351.GeneratedMessageV3.computeStringSize(6, h1_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < h2_.size(); i++) {
          dataSize += computeStringSizeNoTag(h2_.getRaw(i));
        }
        size += dataSize;
        size += 1 * getH2List().size();
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && (hasH1() == other.hasH1());
      if (hasH1()) {
        result = result && getH1()
            .equals(other.getH1());
      }
      result = result && getH2List()
          .equals(other.getH2List());
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
    ...
    public int hashCode() {
      ...
      if (getH2Count() > 0) {
        ...
        hash = (53 * hash) + getH2List().hashCode();
      }
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(ir.sahab.nimroo.serialization.PageDataProto.PageData other) {
        ...
        if (!other.h2_.isEmpty()) {
          if (h2_.isEmpty()) {
            h2_ = other.h2_;
            bitField0_ = (bitField0_ & ~0x00000040);
          } else {
            ensureH2IsMutable();
            h2_.addAll(other.h2_);
          }
          onChanged();
        }
        this.mergeUnknownFields(other.unknownFields);
  ...
  bitField0_ |= 0x00000020;
      ...
      private com.github.os72.protobuf351.LazyStringList h2_ = com.github.os72.protobuf351.LazyStringArrayList.EMPTY;
      private void ensureH2IsMutable() {
        if (!((bitField0_ & 0x00000040) == 0x00000040)) {
          h2_ = new com.github.os72.protobuf351.LazyStringArrayList(h2_);
      ...
      public com.github.os72.protobuf351.ProtocolStringList
          getH2List() {
        return h2_.getUnmodifiableView();
      }
      /**
       * <code>repeated string h2 = 7;</code>
       */
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n)commons/src/main/resources/pagedata.pr" +
      "oto\"Y\n\004Meta\022\014\n\004name\030\001 \002(\t\022\017\n\007content\030\002 \002" +
      "(\t\022\017\n\007charset\030\003 \002(\t\022\021\n\thttpEquiv\030\004 \002(\t\022\016" +
      "\n\006scheme\030\005 \002(\t\"$\n\004Link\022\014\n\004link\030\001 \002(\t\022\016\n\006" +
      "anchor\030\002 \002(\t\"x\n\010PageData\022\013\n\003url\030\001 \002(\t\022\r\n" +
      "\005title\030\002 \002(\t\022\014\n\004text\030\003 \002(\t\022\024\n\005links\030\004 \003(" +
      "\0132\005.Link\022\024\n\005metas\030\005 \003(\0132\005.Meta\022\n\n\002h1\030\006 \001" +
      "(\t\022\n\n\002h2\030\007 \003(\tB.\n\035ir.sahab.nimroo.serial" +
      "izationB\rPageDataProto"
    };
    ...
    internal_static_PageData_fieldAccessorTable = new
      com.github.os72.protobuf351.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PageData_descriptor,
        new java.lang.String[] { "Url", "Title", "Text", "Links", "Metas", "H1", "H2", });
  }
